...
class AtomPairsParameters(Boost.Python.instance):
    ...
    version = '1.1.0'
    pass
class NumRotatableBondsOptions(Boost.Python.enum, int):
    """
    ...
    __slots__ = ()
    names = {'NonStrict': rdkit.Chem.rdMolDescriptors.NumRotatableBondsOptions.NonStrict, 'Strict': rdkit.Chem.rdMolDescriptors.NumRotatableBondsOptions.Strict, 'StrictLinkages': rdkit.Chem.rdMolDescriptors.NumRotatableBondsOptions.StrictLinkages, 'Default': rdkit.Chem.rdMolDescriptors.NumRotatableBondsOptions.Default}
    values = {0: rdkit.Chem.rdMolDescriptors.NumRotatableBondsOptions.NonStrict, 1: rdkit.Chem.rdMolDescriptors.NumRotatableBondsOptions.Strict, 2: rdkit.Chem.rdMolDescriptors.NumRotatableBondsOptions.StrictLinkages, -1: rdkit.Chem.rdMolDescriptors.NumRotatableBondsOptions.Default}
    pass
class Properties(Boost.Python.instance):
    ...
    """
    @staticmethod
    def AnnotateProperties( arg1: Properties, mol: Mol) -> None: 
        """
        AnnotateProperties( arg1: Properties, mol: Mol) -> None
        ...
        """
    @staticmethod
    def ComputeProperties( arg1: Properties, mol: Mol, annotateMol: bool = False) -> _vectd: 
        """
        ComputeProperties( arg1: Properties, mol: Mol, annotateMol: bool = False) -> _vectd
        ...
        """
    @staticmethod
    def GetAvailableProperties() -> _vectNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE: 
        """
        GetAvailableProperties() -> _vectNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE
    ...
    def GetProperty( propName: str) -> PropertyFunctor: 
        """
        GetProperty( propName: str) -> PropertyFunctor
        ...
        """
    @staticmethod
    def GetPropertyNames( arg1: Properties) -> _vectNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE: 
        """
        GetPropertyNames( arg1: Properties) -> _vectNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE
    ...
    @staticmethod
    @typing.overload
    def __init__( arg1: object, arg2: _vectNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE) -> None: ...
    __instance_size__ = 32
    pass
class PropertyFunctor(Boost.Python.instance):
    ...
    """
    @staticmethod
    def GetName( arg1: PropertyFunctor) -> str: 
        """
        GetName( arg1: PropertyFunctor) -> str
        ...
        """
    @staticmethod
    def GetVersion( arg1: PropertyFunctor) -> str: 
        """
        GetVersion( arg1: PropertyFunctor) -> str
        ...
        """
    @staticmethod
    def __call__( arg1: PropertyFunctor, arg2: Mol) -> float: 
        """
        __call__( arg1: PropertyFunctor, arg2: Mol) -> float
...
class PropertyRangeQuery(Boost.Python.instance):
    ...
    """
    @staticmethod
    def Match( arg1: PropertyRangeQuery, arg2: Mol) -> bool: 
        """
        Match( arg1: PropertyRangeQuery, arg2: Mol) -> bool

            C++ signature :
                bool Match(Queries::RangeQuery<double, RDKit::ROMol const&, true> {lvalue},RDKit::ROMol)
        """
    pass
class PythonPropertyFunctor(PropertyFunctor, Boost.Python.instance):
    @staticmethod
    def __call__( arg1: PythonPropertyFunctor, arg2: Mol) -> float: 
        """
        __call__( arg1: PythonPropertyFunctor, arg2: Mol) -> float
            Compute the property for the specified molecule
        ...
        """
    @staticmethod
    def __init__( arg1: object, arg2: object, arg3: str, arg4: str) -> None: 
        """
        __init__( arg1: object, arg2: object, arg3: str, arg4: str) -> None
...
def CalcNumRotatableBonds( mol: Mol, strict: bool) -> int:
    ...
    """
@typing.overload
def CalcNumRotatableBonds( mol: Mol, strict: NumRotatableBondsOptions = NumRotatableBondsOptions.Default) -> int:
    pass
...
def _CalcCrippenContribs( mol: Mol, force: bool = False, atomTypes: list = [], atomTypeLabels: list = []) -> list:
    """
    _CalcCrippenContribs( mol: Mol, force: bool = False, atomTypes: list = [], atomTypeLabels: list = []) -> list
...
def _CalcLabuteASAContribs( mol: Mol, includeHs: bool = True, force: bool = False) -> tuple:
    """
    _CalcLabuteASAContribs( mol: Mol, includeHs: bool = True, force: bool = False) -> tuple
...
def _CalcMolWt( mol: Mol, onlyHeavy: bool = False) -> float:
    """
    _CalcMolWt( mol: Mol, onlyHeavy: bool = False) -> float
...
_CalcCoulombMat_version = '1.0.0'
_CalcCrippenDescriptors_version = '1.2.0'
_CalcEMMcharges_version = '1.0.0'
...
_CalcNumAtoms_version = '1.0.0'
_CalcNumBridgeheadAtoms_version = '2.0.0'
_CalcNumHBA_version = '2.0.1'
_CalcNumHBD_version = '2.0.1'
_CalcNumHeavyAtoms_version = '1.0.0'
...
_CalcNumRotatableBonds_version = '3.1.0'
