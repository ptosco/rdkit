...
class SubstructLibrary(Boost.Python.instance):
    ...
    def CountMatches(self, query: Mol, recursionPossible: bool = True, useChirality: bool = True, useQueryQueryMatches: bool = False, numThreads: int = -1) -> int: 
        """
        CountMatches( self: SubstructLibrary, query: Mol, recursionPossible: bool = True, useChirality: bool = True, useQueryQueryMatches: bool = False, numThreads: int = -1) -> int
    ...
    @typing.overload
    def CountMatches(self, query: object, recursionPossible: bool = True, useChirality: bool = True, useQueryQueryMatches: bool = False, numThreads: int = -1) -> int: ...
    @typing.overload
    def CountMatches(self, query: object, startIdx: int, endIdx: int, recursionPossible: bool = True, useChirality: bool = True, useQueryQueryMatches: bool = False, numThreads: int = -1) -> int: ...
    @typing.overload
    def CountMatches(self, query: object, parameters: SubstructMatchParameters, numThreads: int = -1) -> int: ...
    @typing.overload
    def CountMatches(self, query: object, startIdx: int, endIdx: int, parameters: SubstructMatchParameters, numThreads: int = -1) -> int: ...
    @typing.overload
    ...
    def GetKeyHolder( arg1: SubstructLibrary) -> KeyHolderBase: 
        ...
        """
    @typing.overload
    def GetMatches(self, query: Mol, recursionPossible: bool = True, useChirality: bool = True, useQueryQueryMatches: bool = False, numThreads: int = -1, maxResults: int = 1000) -> _vectj: 
        """
        GetMatches( self: SubstructLibrary, query: Mol, recursionPossible: bool = True, useChirality: bool = True, useQueryQueryMatches: bool = False, numThreads: int = -1, maxResults: int = 1000) -> _vectj
            Get the matches for the query.
        ...
        """
    @typing.overload
    def GetMatches(self, query: Mol, startIdx: int, endIdx: int, recursionPossible: bool = True, useChirality: bool = True, useQueryQueryMatches: bool = False, numThreads: int = -1, maxResults: int = 1000) -> _vectj: ...
    @typing.overload
    def GetMatches(self, query: Mol, parameters: SubstructMatchParameters, numThreads: int = -1, maxResults: int = 1000) -> _vectj: ...
    @typing.overload
    def GetMatches(self, query: Mol, startIdx: int, endIdx: int, parameters: SubstructMatchParameters, numThreads: int = -1, maxResults: int = 1000) -> _vectj: ...
    @typing.overload
    def GetMatches(self, query: object, recursionPossible: bool = True, useChirality: bool = True, useQueryQueryMatches: bool = False, numThreads: int = -1, maxResults: int = 1000) -> _vectj: ...
    @typing.overload
    def GetMatches(self, query: object, startIdx: int, endIdx: int, recursionPossible: bool = True, useChirality: bool = True, useQueryQueryMatches: bool = False, numThreads: int = -1, maxResults: int = 1000) -> _vectj: ...
    @typing.overload
    def GetMatches(self, query: object, parameters: SubstructMatchParameters, numThreads: int = -1, maxResults: int = 1000) -> _vectj: ...
    @typing.overload
    def GetMatches(self, query: object, startIdx: int, endIdx: int, parameters: SubstructMatchParameters, numThreads: int = -1, maxResults: int = 1000) -> _vectj: ...
    @typing.overload
    def GetMatches(self, query: MolBundle, recursionPossible: bool = True, useChirality: bool = True, useQueryQueryMatches: bool = False, numThreads: int = -1, maxResults: int = 1000) -> _vectj: ...
    @typing.overload
    def GetMatches(self, query: MolBundle, startIdx: int, endIdx: int, recursionPossible: bool = True, useChirality: bool = True, useQueryQueryMatches: bool = False, numThreads: int = -1, maxResults: int = 1000) -> _vectj: ...
    @typing.overload
    def GetMatches(self, query: MolBundle, parameters: SubstructMatchParameters, numThreads: int = -1, maxResults: int = 1000) -> _vectj: ...
    @typing.overload
    def GetMatches(self, query: MolBundle, startIdx: int, endIdx: int, parameters: SubstructMatchParameters, numThreads: int = -1, maxResults: int = 1000) -> _vectj: ...
    @staticmethod
    ...
    def HasMatch(self, query: Mol, recursionPossible: bool = True, useChirality: bool = True, useQueryQueryMatches: bool = False, numThreads: int = -1) -> bool: 
        """
        HasMatch( self: SubstructLibrary, query: Mol, recursionPossible: bool = True, useChirality: bool = True, useQueryQueryMatches: bool = False, numThreads: int = -1) -> bool
            Get the matches for the query.
    ...
    @typing.overload
    def HasMatch(self, query: object, recursionPossible: bool = True, useChirality: bool = True, useQueryQueryMatches: bool = False, numThreads: int = -1) -> bool: ...
    @typing.overload
    def HasMatch(self, query: object, startIdx: int, endIdx: int, recursionPossible: bool = True, useChirality: bool = True, useQueryQueryMatches: bool = False, numThreads: int = -1) -> bool: ...
    @typing.overload
    def HasMatch(self, query: object, parameters: SubstructMatchParameters, numThreads: int = -1) -> bool: ...
    @typing.overload
    def HasMatch(self, query: object, startIdx: int, endIdx: int, parameters: SubstructMatchParameters, numThreads: int = -1) -> bool: ...
    @typing.overload
