...
RDKIT_RGROUPDECOMPOSITION_EXPORT extern const std::string TARGET_ATOM_INDICES;
RDKIT_RGROUPDECOMPOSITION_EXPORT extern const std::string TARGET_BOND_INDICES;
