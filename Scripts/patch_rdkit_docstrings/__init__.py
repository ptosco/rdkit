...
class FixSignatures:
    ...
    rdkit_include_path = cpp_source_path
    ...
    def get_rdk_build_flags(self):
        ...
        based on the contents of Code/RDgenral/RDConfig.h.

        Returns:
            str: command line clang++ flags
        """
        rdconfig_h = os.path.join(self.rdkit_include_path, "Code", "RDGeneral", "RDConfig.h")
        definitions = set()
        includes = set()
        with open(rdconfig_h, "r") as hnd:
            for line in hnd:
                ...
                if not isinstance(include_path, str):
                    include_path = os.path.join(self.rdkit_include_path, *include_path)
    ...
    def init_clang_worker_data(self):
        ...
        rdkit_code = os.path.join(self.rdkit_include_path, "Code")
        rdkit_external = os.path.join(self.rdkit_include_path, "External")
